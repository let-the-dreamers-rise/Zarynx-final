...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface AgentIdentityRegistryInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "isApprovedForAll" | "name" | "nextTokenId" | "owner" | "ownerOf" | "registerAgent" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership" | "updateAgentUri"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "AgentMetadataUpdated" | "AgentRegistered" | "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "OwnershipTransferred" | "Transfer"): EventFragment;
...
encodeFunctionData(functionFragment: 'registerAgent', values: [AddressLike, string]): string;
...
encodeFunctionData(functionFragment: 'updateAgentUri', values: [BigNumberish, string]): string;
...
decodeFunctionResult(functionFragment: 'updateAgentUri', data: BytesLike): Result;
  }
    ...
    export namespace AgentMetadataUpdatedEvent {
      ...
      export interface OutputObject {agentId: bigint, agentUri: string };
    ...
    export namespace AgentRegisteredEvent {
      export type InputTuple = [agentId: BigNumberish, operator: AddressLike, owner: AddressLike, agentUri: string];
      export type OutputTuple = [agentId: bigint, operator: string, owner: string, agentUri: string];
      export interface OutputObject {agentId: bigint, operator: string, owner: string, agentUri: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
...
getFunction(nameOrSignature: 'transferOwnership'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'updateAgentUri'): TypedContractMethod<
      [agentId: BigNumberish, agentUri: string, ],
      [void],
      'nonpayable'
    >;

    getEvent(key: 'AgentMetadataUpdated'): TypedContractEvent<AgentMetadataUpdatedEvent.InputTuple, AgentMetadataUpdatedEvent.OutputTuple, AgentMetadataUpdatedEvent.OutputObject>;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'AgentMetadataUpdated(uint256,string)': TypedContractEvent<AgentMetadataUpdatedEvent.InputTuple, AgentMetadataUpdatedEvent.OutputTuple, AgentMetadataUpdatedEvent.OutputObject>;
      AgentMetadataUpdated: TypedContractEvent<AgentMetadataUpdatedEvent.InputTuple, AgentMetadataUpdatedEvent.OutputTuple, AgentMetadataUpdatedEvent.OutputObject>;
    

      'AgentRegistered(uint256,address,address,string)': TypedContractEvent<AgentRegisteredEvent.InputTuple, AgentRegisteredEvent.OutputTuple, AgentRegisteredEvent.OutputObject>;
